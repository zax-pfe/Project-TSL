import { TempNode } from "./three_webgpu.js";
import { Fn, clamp, fract, mix, nodeProxy, rand, time, uv, vec4 } from "./three_tsl.js";
//#region node_modules/three/examples/jsm/tsl/display/FilmNode.js
/**
	...
	*/
	setup() {
		...
		return Fn(() => {
			...
			let color = base.add(base.mul(clamp(noise.add(.1), 0, 1)));
			if (this.intensityNode !== null) color = mix(base, color, this.intensityNode);
...
* @returns {FilmNode}
*/
var film = /*@__PURE__*/ nodeProxy(FilmNode);
//#endregion
export { FilmNode as default, film };
